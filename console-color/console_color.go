...
type ConsoleColorClass struct {

}

var ConsoleColor = ConsoleColorClass{}
...
func (this *ConsoleColorClass) Blue(s string) string {
...
func (this *ConsoleColorClass) LightGreen(s string) string {
...
func (this *ConsoleColorClass) Purple(s string) string {
...
func (this *ConsoleColorClass) White(s string) string {
...
func (this *ConsoleColorClass) Gray(s string) string {
...
func (this *ConsoleColorClass) Red(s string) string {
...
func (this *ConsoleColorClass) RedBackground(s string) string {
...
func (this *ConsoleColorClass) Green(s string) string {
...
func (this *ConsoleColorClass) Yellow(s string) string {
